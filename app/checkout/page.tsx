...
const CheckoutPage = () => {
    ...
    return (
        <main className="min-h-screen bg-black text-white selection:bg-primary selection:text-black flex flex-col">
            ...
            <div className="flex-grow pt-32 px-6 pb-20">
                <div className="container mx-auto max-w-[1240px]">
                    ...
                    <div className="text-center mb-16 relative z-10">
                        <h1 className="text-3xl md:text-[50px] font-heading font-medium leading-tight">
                    ...
                    {/* Glassy Container */}
                    <div className="relative rounded-[30px] bg-[rgba(17,17,17,0.1)] border border-white/5 backdrop-blur-sm overflow-hidden p-12 md:p-16">
                        ...
                        <div className="relative z-10 flex flex-col lg:flex-row justify-center gap-10 lg:gap-20">
                            ...
                            <div className="w-full max-w-[450px]">
                                ...
                                <div className="bg-[#121212] border border-gray-800 rounded-[20px]  p-8 relative overflow-hidden">
                                    {/* Glow Effect */}
                                    ...
                                    <div className="relative w-full rounded-[20px] bg-white/[0.04] border border-white/10 backdrop-blur-2xl px-8 py-2 mb-4">
                                        <h2 className="text-[24px] font-normal leading-tight">
                                    ...
                                    <div className="flex items-center gap-4 my-8 relative">
                                        <span className="text-primary text-3xl  font-bold relative">
                                            $49.99
                                            <div className="absolute inset-0 flex items-center justify-center">
                                                <div className="w-full h-[2px] bg-red-600 rotate-[-12deg]"></div>
                                            </div>
                                        </span>
                                        <span className="text-primary text-[32px] font-bold">→ $19.99</span>
                                    </div>
