            ...
            <div className="container mx-auto max-w-[1280px]">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-start">
                    ...
                    <div className="flex flex-col gap-5 md:gap-7 w-full max-w-[500px] animate-slide-up delay-200">
                        ...
                        <div className="relative w-full min-h-[82px] bg-black border border-primary rounded-[10px] px-6 py-4 flex flex-col justify-center">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <PhoneInput
                                        ...
                                        className="phone-input-custom w-[180px]"
                                    />
                                </div>
                            </div>
                        </div>
